let handler = async (m, { conn, command, text }) => {
    ...
    if (!text) return conn.reply(m.chat, 'حط اسم او منشن حدا', m)
...
*┃• دائما* : ${pickRandom(['متوتر','سيء','مشتت','مزعج','نمام','بيقرا كتب','خروجات','بيتفرج ع الانمي','فاتح واتس','بيكذب','سيمب','ماسك الفون'])}
